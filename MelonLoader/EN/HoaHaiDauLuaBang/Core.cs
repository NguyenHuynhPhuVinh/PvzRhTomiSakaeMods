...
namespace HoaHaiDauLuaBang
{
    ...
    public class Core : MelonMod
    {
        ...
        public override void OnInitializeMelon()
        {
            ...
            string plantName = "Twin Fire-Ice Sunflower"; // English name
            string plantDescription =
                "Produces two suns at once, creates fire and freezes zombies on multiple rows.\n" + // Tagline
                "Sun production: <color=red>50 sun/15 seconds</color>\n" + // Production info
                "Recipe: <color=blue>Fire Sunflower + Ice Sunflower</color>\n\n" + // Recipe info
                "Twin Fire-Ice Sunflower combines the power of fire and ice, producing double sun and creating effects on multiple rows. Has a 30% chance to affect all 3 rows simultaneously, with fire and ice randomly distributed between upper and lower rows, creating a powerful combination of damage and slowing effects."; // Lore description
