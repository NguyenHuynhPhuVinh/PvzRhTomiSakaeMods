...
namespace HoaHaiDauLua
{
    ...
    public class Core : MelonMod
    {
        ...
        public override void OnInitializeMelon()
        {
            ...
            string plantName = "Twin Fire Sunflower"; // English name
            string plantDescription =
                "Produces two suns at once and creates fire lines on multiple rows.\n" + // Tagline
                "Sun production: <color=red>50 sun/15 seconds</color>\n" + // Production info
                "Recipe: <color=red>Fire Sunflower + Fire Sunflower</color>\n\n" + // Recipe info
                "Twin Fire Sunflower produces double sun and creates fire lines with 1800 damage on the current row and adjacent rows. Has a 30% chance to create fire on all 3 rows simultaneously, creating a wide damage zone to burn multiple zombies."; // Lore description
