...
namespace HoaHaiDauBang
{
    ...
    public class Core : MelonMod
    {
        ...
        public override void OnInitializeMelon()
        {
            ...
            string plantName = "Twin Ice Sunflower"; // English name
            string plantDescription =
                "Produces two suns at once and freezes zombies on multiple rows.\n" + // Tagline
                "Sun production: <color=blue>50 sun/15 seconds</color>\n" + // Production info
                "Recipe: <color=blue>Ice Sunflower + Ice Sunflower</color>\n\n" + // Recipe info
                "Twin Ice Sunflower produces double sun and freezes zombies on the current row and adjacent rows. Has a 30% chance to freeze zombies on all 3 rows simultaneously, creating a wide control zone to slow down multiple zombies for 10 seconds."; // Lore description
